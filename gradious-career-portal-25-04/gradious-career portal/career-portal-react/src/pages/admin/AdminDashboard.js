...
function AdminDashboard() {
  ...
  const doughnutData = {
    ...
    datasets: [
      {
        data: counts,
        backgroundColor: ["#0d9488", "#059669", "#d97706", "#78716c"],
        borderColor: "#ffffff",
        borderWidth: 3,
        hoverOffset: 6,
        spacing: 2,
      ...
      <div className="admin-dashboard-page">
        <header className="dash-page-intro">
          ...
          <p className="dash-page-desc">
            Key metrics across users, recruiters, jobs, and applications.
          </p>
        </header>
            ...
            <div className="admin-chart-grid">
              <div className="admin-chart-card dash-chart-panel">
                <div className="dash-chart-head">
                  ...
                  <p>Entity counts across the platform</p>
                </div>
              ...
              <div className="admin-chart-card dash-chart-panel">
                <div className="dash-chart-head">
                  ...
                  <p>Proportional share of each entity type</p>
                </div>
